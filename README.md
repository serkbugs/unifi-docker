...
**The current "latest" version is Unifi Controller 9.3.43.
...
|-----|-------------|-----------|
| [`latest` `v9.3.43`](https://github.com/serkbugs/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 7.5.176 as of 2023-09-15 |[Change Log 7.5.176](https://community.ui.com/releases/UniFi-Network-Application-7-5-176/0a224764-0603-4a8b-a038-1a7d59c6615c)|
...
## Mac
Steps below were taken from [this link](https://code.saghul.net/2023/09/migrating-from-docker-desktop-to-colima/) 
